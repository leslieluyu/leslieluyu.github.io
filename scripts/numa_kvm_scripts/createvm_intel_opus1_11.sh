...
IP1=172.31.150.11/24
IP2=172.31.151.11/24
INSTANCE1_NAME=worker1-numa0
INSTANCE2_NAME=worker1-numa1
...
GATEWAY1=172.31.150.11
GATEWAY2=172.31.151.11

IMAGE_SIZE=30G
VCPU_NUM=72
CPU_SET1="0-35,72-107"
CPU_SET2="36-71,108-143"
MEM_SIZE=102400 #100G
VM_ETH2=enp5s0
SSH_PUB_FILE=~/.ssh/id_rsa.pub
HTTP_PROXY=http://proxy-dmz.intel.com:912
NO_PROXY=localhost,127.0.0.1,intel.com,.intel.com,172.31.150.0/24,172.31.151.0/24,192.168.0.0/16
