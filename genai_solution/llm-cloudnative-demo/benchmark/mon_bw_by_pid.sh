...
while true; do
    sum=0
    value_1=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_00/llc_occupancy)
    value_2=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_01/llc_occupancy)

 

    mem_bw_0_local=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_00/mbm_local_bytes)
    mem_bw_0_total=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_00/mbm_total_bytes)
    mem_bw_1_local=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_01/mbm_local_bytes)
    mem_bw_1_total=$(cat /sys/fs/resctrl/cri-resmgr.high/${path}/mon_data/mon_L3_01/mbm_total_bytes)
